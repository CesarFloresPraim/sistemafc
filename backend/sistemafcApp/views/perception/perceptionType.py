...
class PerceptionTypeView(APIView):
    authentication_classes = []
    permission_classes = []

    def get(self, request, id):
        try:
            dataSerialized = PerceptionTypeSerializer(
                PerceptionType.objects.get(id=id)).data
