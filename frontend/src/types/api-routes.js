export const apiRoutes = {
  ...
  FETCH_DEPARTMENT_FULL_LIST: "api/v1.0/departments/",
  ...
  FETCH_EMPLOYEE_VACATIONS_LIST: "api/v1.0/employeeVacationList/",
  CREATE_VACATION: "api/v1.0/vacation/",
  EDIT_VACATION: "api/v1.0/vacation/",
