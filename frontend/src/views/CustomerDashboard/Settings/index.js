          ...
          <div className="hidden lg:block">
            <TopBar title={topbarTitle} breadcrums={topbarBreadcrums}>
              <ProfileProgress
                ...
                setCollapsed={setIsProgressVisible}
              ></ProfileProgress>
              {activeRoute != "settings-password" ? (
                <div className="hidden bg-white xl:flex ">
                  <div className="mx-4 h-12 px-4 flex justify-center items-center rounded-[32px] text-[13px] text-primary border border-porcelain">
                    Cancel
                  </div>

                  <div className="justify-center flex items-center rounded-[32px] text-[13px] text-white bg-primary">
            ...
            <ul className="flex items-center">
              ...
              >
                <NavLink
                  ...
                  onClick={() =>
                    setActiveRoute("settings-personal-information")
                  }
                >
              ...
              <li
                className={` ${
                  activeRoute === "settings-account-focus"
                    ? "text-primary border-b-2 border-b-primary font-semibold"
                    : "bg-transparent text-regentGray"
                } cursor-pointer mt-1 py-1 px-2 text-sm`}
              >
                <NavLink
                  to="settings-account-focus"
                  className={`flex items-center p-1`}
                  onClick={() => setActiveRoute("settings-account-focus")}
                >
                  Account focus
                </NavLink>
              </li>
              ...
              >
                <NavLink
                  ...
                  className={`flex items-center p-1`}
                  onClick={() => setActiveRoute("settings-password")}
                >
                  Password
                </NavLink>
              </li>
