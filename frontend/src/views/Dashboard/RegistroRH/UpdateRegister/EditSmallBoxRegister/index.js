...
export default function EditSmallBoxRegister() {
  ...
  const { selectedRegister, smallBoxRegisters, search } = useSelector((state) => state.rh);
  ...
  const renderSmallBoxRegisters = () => {
    if (selectedRegister.registersDetails && selectedRegister.registersDetails?.length > 0) {
